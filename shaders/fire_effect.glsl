// Procedural Fire Shader for TouchDesigner
// Based on Simplex Noise

uniform float uTime;
uniform vec2 uIndexPos; // Position from hand tracking
uniform float uIntensity; // Intensity that fades out over 2-3 seconds
...
void main() {
    ...
    // Flip Y because webcam/tracking coordinates are often inverted
    ...
    // Apply intensity (fades out after snap)
    flame_shape *= uIntensity;
